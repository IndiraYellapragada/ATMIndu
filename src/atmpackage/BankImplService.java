 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://atmpackage/", wsdlLocation = "http://jyothi:8080/InduATM/BankImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKIMPLSERVICE_QNAME = new QName("http://atmpackage/", "BankImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://jyothi:8080/InduATM/BankImplService?wsdl");
    ...
    public BankImpl getBankImplPort() {
        return super.getPort(new QName("http://atmpackage/", "BankImplPort"), BankImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "BankImplPort")
    public BankImpl getBankImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://atmpackage/", "BankImplPort"), BankImpl.class, features);
    }
